    ...
    public class FaceSearchController : Controller
    {
        ...
        public async Task<IActionResult> Search(IFormFile face, string day)
        {
            ...
            if (HttpContext.Session.GetString("face_search_name") == "Demo User")
            {
                ...
                var demoResults = new[]
     {
    new { url = "https://drive.google.com/uc?export=view&id=1saLYwCjWgjvtibcyUVb4LihLiFp_sSXD",
          filename = "event-photo-1.jpg", confidence = 95.5m, s3_key = "demo/1" },
    new { url = "https://drive.google.com/uc?export=view&id=1mhT5ds8rRbKQDjFRLhKNkZQgESVrLCcg",
          filename = "event-photo-2.jpg", confidence = 89.2m, s3_key = "demo/2" },
    new { url = "https://drive.google.com/uc?export=view&id=1vtGul7g8HP8ZLOhMS-IxyiHEVv-X6IXR",
          filename = "event-photo-3.jpg", confidence = 82.7m, s3_key = "demo/3" },
    new { url = "https://drive.google.com/uc?export=view&id=1_OjqdaYZt7_5uahSyAy-Q99yAjyExj0_",
